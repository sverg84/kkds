  ...
  return (
    <div className="space-y-6">
      <DocBlock
        ...
        accessibility="When href is provided the card is wrapped in a semantic <a> and its title becomes the accessible link label. Avoid nesting interactive elements (e.g. FavoriteButton) inside an href card — that creates nested interactive regions which fail WCAG 2.1."
        example={`<RecipeCard
  title={recipe.title}
