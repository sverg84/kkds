    ...
    <div className="space-y-10">
      ...
      <div className="rounded-xl border bg-card p-5 space-y-3 text-sm">
        ...
        <p className="text-muted-foreground leading-relaxed">
          Two-column layout: left column holds the recipe image and actions;
          right column holds title, attribution, metadata, badges, and content.
          Image column is{" "}
          <code className="rounded bg-muted px-1 py-0.5 text-xs">2fr</code>,
          content column is{" "}
          <code className="rounded bg-muted px-1 py-0.5 text-xs">3fr</code>.
          Stacks to a single column below the{" "}
