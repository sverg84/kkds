...
const MY_RECIPES = [
  {
    ...
    description:
      "A classic Roman pasta dish — rich, silky, and deeply satisfying.",
    imageUrl:
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1476124369491-e7addf5db371?w=640&h=360&fit=crop",
...
const FAVORITES = [
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1541519227354-08fa5d50c820?w=640&h=360&fit=crop",
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1565557623262-b51c2513a641?w=640&h=360&fit=crop",
    tags: ["Indian", "Dinner"],
    prepTime: "20 min",
    cookTime: "35 min",
  },
    ...
    <div className="space-y-10">
      ...
      <div className="rounded-xl border bg-card p-5 space-y-3 text-sm">
        ...
        <p className="text-muted-foreground leading-relaxed">
          RecipeAuthor header sits outside and above the Tabs component so it
          remains visible during tab switching. Each TabsContent panel uses the
          same responsive grid as Recipe Discovery. The KKDS Tabs component uses
          a CSS-driven indicator by default; for a spring-animated indicator see
          the animation note in{" "}
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-start justify-between">
          <RecipeAuthor
            ...
            subtitle="3 recipes · 2 favorites"
          />
