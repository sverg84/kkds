# KitchenKin Design System design system
...
workspace package (`@workspace/kitchenkin-ds`): other artifacts depend
...
`@workspace/kitchenkin-ds/components/...`. Never use a `@/` alias inside
...
for `@workspace/kitchenkin-ds` and renders mockups using this package's
theme and components.

## Consuming this package

Never copy token values, component source, hooks, or these docs into a consuming
artifact. Add `@workspace/kitchenkin-ds` as a `workspace:*` dependency,
